...
FRAME_WAIT_TIME = 15             # Zeit die wir bei einem Frame warten auf ein ACK bis wir neu senden
WAIT_FOR_ACK_TIME = 10           # Zeit die wir bei MSG oder File_Info auf ein ACK warten
